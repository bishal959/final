...
// Specify the subject for which you want to display the attendance
...
echo ' db CSV file exported successfully';

$deleteQuery = "DELETE FROM attendance";
if ($conn->query($deleteQuery) === TRUE) {
    echo 'All data deleted from the database.';
} else {
